...
Stlačiteľnosť plynov umožňuje ich využitie na tlmenie nárazov (miesto pružiny) v aute či na prednej vidlici na bicykli. Akú výhodu má vzduchový tlmič oproti pružinovému? [Ľahko nastaviteľná tuhosť aj výška, dá sa dynamicky meniť podľa záťaže, stačí prifúknuť vzduch. Pružina je z výroby fixná.] Kde inde využívame stlačený vzduch? [Pneumatiky, čistenie, nástroje (napr. skrutkovač v pneuservise), rozprašovanie farby, automatické brzdenie vo vlaku (ak sa za jazdy odpojí vagón, roztrhne sa natlakovaná hadica, čím v nej tlak klesne, vzduch prestane tlačiť proti pružine vo vzduchovej brzde, tá zaberie a zastaví vlak)...]
...
* [hydraulický lis](https://youtu.be/CbGrjhDtLGw?t=260) (takisto funguje zdvihák v autoservise)
